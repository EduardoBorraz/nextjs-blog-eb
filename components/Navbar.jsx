...
export default function Navbar() {
  ...
  return (
    <div className="w-full bg-white border-b-2 border-grey-200 p-4 grid md:grid-cols-12 gap-4 items-center justify-center px-20">
      <h1 className="md:col-span-2 flex justofy-center md:justify-start font-bold text-2xl text-blue-900">
        <Link href="/">EB</Link>
      </h1>
      ...
      <div className="md:col-span-2 flex items-center justify-center md:justify-end gap-4">
        <Link href="https://web.facebook.com/joseeduardo.borrazjuarez">
          <svg
        ...
        <Link href="https://github.com/EduardoBorraz">
          <svg
            className="w-6 h-6 fill-current"
            viewBox="0 0 24 24"
            fill="none"
